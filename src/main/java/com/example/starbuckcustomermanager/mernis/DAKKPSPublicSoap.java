...
public class DAKKPSPublicSoap
{
    ...
    public DAKKPSPublicSoap(){}

    public DAKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DAKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DAKExtendedSoapSerializationEnvelope envelope= new DAKExtendedSoapSerializationEnvelope(DAKExtendedSoapSerializationEnvelope.VER11);
