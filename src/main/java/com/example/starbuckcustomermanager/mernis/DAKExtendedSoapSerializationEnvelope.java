...
class DAKSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class DAKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DAKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DAKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DAKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DAKDateTimeConverter dateTimeConverter = new DAKStandardDateTimeConverter();

    public DAKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DAKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DAKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DAKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DAKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DAKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
